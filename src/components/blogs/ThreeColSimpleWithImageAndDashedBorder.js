...
const Image = styled.div(props => [
  ...
  tw`bg-cover bg-center h-80 lg:h-64 rounded-t-none rounded-b-none`
]);

const Details = tw.div`p-6 rounded-t-none border-2 border-t-0  border-dashed border-primary-100 flex-1 flex flex-col items-center text-center lg:block lg:text-left`;
