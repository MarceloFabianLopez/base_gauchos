...
const Content = tw.div`max-w-screen-xl mx-auto py-20 lg:py-24 bg-yellow-200`;
const CabezaContainer = styled.div`
  ${tw`p-10 sm:p-12 md:p-16 bg-gray-400 text-gray-100 rounded-lg relative`}
  form {
    ${tw`mt-4`}
  }
  h2 {
...
`;
//const Rojo = tw.div`p-10 sm:p-12 md:p-16 bg-primary-500 text-gray-100 rounded-lg relative`;
